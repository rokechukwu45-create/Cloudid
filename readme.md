...
**CloudID-Hunter** is a zero-dependency, concurrent command-line interface (CLI) tool engineered to discover, audit, and flag exposed cloud metadata fabrics, link-local configuration leaks, and plaintext service tokens. 
...
## 📖 Table of Contents
1. [Core Capabilities Explained](#-core-capabilities-explained)
2. [Directory Structure Setup](#-directory-structure-setup)
3. [Installation Methods](#-installation-methods)
4. [Command-Line Arguments Reference](#-command-line-arguments-reference)
5. [Step-by-Step Usage & Command Explanations](#-step-by-step-usage--command-explanations)
